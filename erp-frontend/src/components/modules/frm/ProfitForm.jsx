                    ...
                    {!initialData && (
                      <div>
                        ...
                        <input
                          ...
                          className="mt-1 block w-full rounded-lg border border-gray-300 bg-gray-50 py-1.5 px-3 text-sm focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                          readOnly
                        />
                      </div>
                    )}
